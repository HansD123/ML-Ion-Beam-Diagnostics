...
images generated by the custom implementation. Older script that optimises each filter
thickness independently rather than using the exponential parameterisation.
"""
